 ...
 */
public class LeftAddMethodHandler implements MethodHandler {

    @Override
    public String[] handledRequests() {
        return new String[]{"leftAdd"};
    }

    @Override
    public MethodHandler getNewInstance() {
        return new LeftAddMethodHandler();
    }
    ...
    public Response process(Request req) {
        ...
        StorageHandler.getInstance().leftAdd(key, value); // TODO: Add response on error to set value
